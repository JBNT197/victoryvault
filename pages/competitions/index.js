...
export default function Competitions() {
  const comps = [
    { id: 1, title: 'iPhone 15 Pro 256 GB', img: 'https://i.imgur.com/8vL3cUF.jpg', price: 2.5, sold: 13, cap: 1000 },
    { id: 2, title: '£1,000 Cash Prize', img: 'https://i.imgur.com/0KFBHTB.jpg', price: 1.99, sold: 212, cap: 1500 },
  ]

  return (
    <>
      <Head><title>Live Competitions | Victory Vault</title></Head>
      ...
      <section className="max-w-5xl mx-auto p-6">
        <h2 className="text-2xl font-medium mb-6">Live Competitions</h2>
...
function CompCard({ id, title, img, price, sold, cap }) {
  ...
  return (
    <div className="card border rounded-lg p-4 text-center">
      ...
      <Link href={`/competition/${id}`} className="btn-primary">Enter</Link>
    </div>
  )
}
